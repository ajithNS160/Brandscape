...
public class BWS_AdminCommunication  extends BaseClass {
	...
	public static void Login() throws Throwable {
		...
		Thread.sleep(2000);
		GetWebElementandClick("Users");
		Thread.sleep(3000);
		TypeDataInTheElement("SearchUserToMessage", "Bat");	
		Calendar("SelectUserFromList", "Batmobile");
		Thread.sleep(3000);
		TypeDataInTheElement("TypeMessage", "Hai BatMobile");
